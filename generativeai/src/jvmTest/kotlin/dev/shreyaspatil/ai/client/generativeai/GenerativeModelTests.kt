...
import dev.shreyaspatil.ai.client.generativeai.type.Candidate
...
import dev.shreyaspatil.ai.client.generativeai.type.content
import dev.shreyaspatil.ai.client.generativeai.type.defineFunction
...
import dev.shreyaspatil.ai.client.generativeai.common.GenerateContentRequest as GenerateContentRequest_Common
import dev.shreyaspatil.ai.client.generativeai.common.GenerateContentResponse as GenerateContentResponse_Common
import dev.shreyaspatil.ai.client.generativeai.common.InvalidAPIKeyException as InvalidAPIKeyException_Common
import dev.shreyaspatil.ai.client.generativeai.common.UnsupportedUserLocationException as UnsupportedUserLocationException_Common
import dev.shreyaspatil.ai.client.generativeai.common.UsageMetadata as UsageMetadata_Common
import dev.shreyaspatil.ai.client.generativeai.common.server.Candidate as Candidate_Common
import dev.shreyaspatil.ai.client.generativeai.common.server.CitationMetadata as CitationMetadata_Common
import dev.shreyaspatil.ai.client.generativeai.common.shared.Content as Content_Common
import dev.shreyaspatil.ai.client.generativeai.common.shared.FunctionCallPart as FunctionCallPart_Common
import dev.shreyaspatil.ai.client.generativeai.common.shared.TextPart as TextPart_Common
            ...
            content("function") {
                part(
                    FunctionResponsePart(
                        "getExchangeRate",
                        buildJsonObject {
                            this.put("exchangeRate", JsonPrimitive("200%"))
                        },
                    ),
                )
            }
